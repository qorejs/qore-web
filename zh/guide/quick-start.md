...
- [为什么选择 Qore](/zh/guide/why-qore) - 了解 Qore 的优势
- [核心概念](/zh/guide/core-concepts) - 深入理解设计理念
- [响应式系统](/zh/guide/reactivity) - 学习 Signal 的奥秘

### 💻 实战示例

- [计数器示例](/zh/examples/counter) - 完整代码
- [Todo 列表](/zh/examples/todo) - 经典入门项目
- [AI 集成](/zh/examples/ai-integration) - 体验 AI 流集成
...
A: Qore 专为 AI 时代设计，提供更优的性能（5KB vs 45KB）、更简洁的 API、和原生的 AI 集成能力。详见 [为什么选择 Qore](/zh/guide/why-qore)。

### Q: Qore 支持 SSR 吗？

A: 支持！Qore 原生支持流式 SSR，详见 [服务端渲染指南](/zh/guide/ssr)。
...
- 📖 [完整文档](/zh/guide/getting-started)
- [GitHub Issues](https://github.com/qorejs/qore/issues)
- [官网源码](https://github.com/qorejs/qore-web)
